...
import { A as colors, v as createLogger, r as resolveConfig } from './chunks/dep-CqG5PZEH.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./chunks/dep-CqG5PZEH.js').then(function (n) { return n.E; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('./chunks/dep-CqG5PZEH.js').then(function (n) { return n.F; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('./chunks/dep-CqG5PZEH.js').then(function (n) { return n.D; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('./chunks/dep-CqG5PZEH.js').then(function (n) { return n.G; });
    try {
